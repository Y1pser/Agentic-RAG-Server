#!/usr/bin/env python3
"""
Spec Sync — splits the design spec into chapter files under auto-coder/references/.
...
def sync(force: bool = False):
    ...
    spec_path = repo_root / "docs" / "superpowers" / "specs" / "2026-06-21-agentic-rag-server-design.md"
    specs_dir = skill_dir / "references"
    hash_file = skill_dir / ".spec_hash"

    if not spec_path.exists():
        print(f"ERROR: {spec_path} not found"); sys.exit(1)
